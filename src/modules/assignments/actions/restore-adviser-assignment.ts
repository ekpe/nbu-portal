...
export async function restoreAdviserAssignmentAction(formData: FormData): Promise<void> {
  ...
  await writeAuditLog({
    actorId,
    action: "ADVISER_ASSIGNMENT_RESTORED",
    entityType: "ADVISER_ASSIGNMENT",
    entityId: assignment.id,
    summary: "Restored adviser assignment",
    beforeJson: before,
